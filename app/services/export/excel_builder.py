...
def build_project_xlsx(
    ...
    # Этап 8.6: НЕ удаляем строку 2 (как было в 8.4) — иначе N2/O2 с
    # курсом съезжают наверх и налезают на шапку, а заголовки таблицы
    # — на бывшую N1/O1. Вместо удаления делаем строку 2 компактной
    # и оставляем A2 пустой.
    ws["A2"] = None
