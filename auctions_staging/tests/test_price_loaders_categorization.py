...
from app.modules.auctions.price_loaders.merlion import _classify_merlion
from app.modules.auctions.price_loaders.ocs import _classify_ocs
from app.modules.auctions.price_loaders.resursmedia import _classify_resursmedia
from app.modules.auctions.price_loaders.treolan import _classify_treolan


# === MERLION ===
# Реальные значения G3 из seed merlion_price.xlsm (после prefilter g1='Периферия и аксессуары', g2='Принтеры').
...
# === OCS ===
# Реальные пары (B, C) из seed ocs_price.xlsx.
...
# === TREOLAN ===
# Реальные пути из seed treolan_catalog.xlsx (sniff_categories.out).
...
# === RESURS-MEDIA ===
# Имена моделей — паттерны, реально встречающиеся в priceresurs.xlsx.
