...
def test_kp_endpoint_returns_docx(
    ...
    with _router_mock_rate():
        r = manager_client.get(f"/configurator/project/{pid}/export/kp?markup=15")
...
def test_kp_endpoint_default_markup_is_15(
    ...
    with _router_mock_rate():
        r_default = manager_client.get(f"/configurator/project/{pid}/export/kp")
        r_explicit = manager_client.get(f"/configurator/project/{pid}/export/kp?markup=15")
...
def test_kp_endpoint_rejects_markup_above_500(
    ...
    with _router_mock_rate():
        r = manager_client.get(f"/configurator/project/{pid}/export/kp?markup=600")
...
def test_kp_endpoint_forbidden_for_other_user(
    ...
    with _router_mock_rate():
        r = app_client.get(f"/configurator/project/{pid}/export/kp?markup=15")
    assert r.status_code == 403


def test_kp_endpoint_404_for_missing_project(manager_client):
    with _router_mock_rate():
        r = manager_client.get("/configurator/project/999999/export/kp?markup=15")
