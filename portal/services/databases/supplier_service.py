# Сервис управления поставщиками раздела «Базы данных» портала.
#
# Изначально создан на этапе 9А.2 как app/services/supplier_service.py
# (закрытие техдолга 8.3 в конфигураторе). На этапе UI-2 Пути B
# (2026-05-11) переехал сюда вместе со страницами «Поставщики» в portal.
#
# До этого этапа email/контакты у suppliers редактировались только
# через psql. Теперь админ ведёт справочник через /databases/suppliers.
#
