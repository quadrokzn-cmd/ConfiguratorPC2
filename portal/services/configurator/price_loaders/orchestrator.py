...
def load_price(
    ...
    *,
    ...
    from portal.services.configurator.price_loaders import get_loader
    ...
    try:
        from portal.services.configurator.enrichment.openai_search.hooks import auto_enrich_new_skus
...
def save_price_rows(
    *,
    ...
    Используется auto-fetcher'ами (portal.services.configurator.auto_price.fetchers.*),
