...
from portal.services.configurator.enrichment.openai_search.schema import DEFAULT_MODEL
...
def _calc_cost_usd(tokens_in: int, tokens_out: int, web_searches: int) -> float:
    from portal.services.configurator.enrichment.openai_search.cost_guard import (
