...
_TIMEOUT_SEC = 5.0
# UI-4 (Путь B, 2026-05-11): parents[4] → parents[5] после переноса
# в portal/services/configurator/enrichment/openai_search.
_CACHE_FILE = Path(__file__).resolve().parents[5] / "data" / ".fx_cache.json"
