...
> **Sentry vs аудит-лог.** Sentry собирает **ошибки** (5xx, исключения).
> Внутренний аудит-лог в Postgres (этап 9В.4) фиксирует **нормальные
> действия** — login, создание/удаление проектов, экспорт КП и т.д. —
> для compliance и расследования инцидентов. Это два разных инструмента
> с разной ответственностью. См. [audit_log.md](audit_log.md).
