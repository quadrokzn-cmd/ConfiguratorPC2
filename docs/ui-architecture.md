...
этапа **UI-1** Пути B (слияние портала и конфигуратора в одно FastAPI;
полный план — `plans/2026-05-11-ui-merge-portal-configurator.md`).
...
- **UI-2..UI-5 (план):** переезд роутеров в `portal/`, упразднение
